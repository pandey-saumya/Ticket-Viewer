"""
Model of the model package in MVC . Does the following: authentication, fetching tickets, processing data got
...
class APIRequestHandler:
    def __init__(self):
        ...
        self.subdomain = "saumyapandey"  # Zendesk API subdomain
        self.loginID = "saumya96pandey@gmail.com"  # Zendesk API username
        self.password = "Avengers123"  # Zendesk API password
        self.errorCode = None
