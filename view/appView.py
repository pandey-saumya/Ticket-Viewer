"""
A Passive View in the view package for the MVC. Its ticket data is what the controller passes to it.
ticket information on the CLI screen.
"""
import math
...
class AppView:
    ...
    def quit(self):  # Displays quit message and quits the App.
        ...
        print("Exiting successful, Have a good day.\n")
        return 0
